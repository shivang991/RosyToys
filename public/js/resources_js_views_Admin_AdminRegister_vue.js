...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'RegisterForm',
  emits: ["email-error", "general-error", "success"],
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    function handleSuccess(accessToken) {
      axios.setUser(accessToken).then(function () {
        (0,_plugins_Notifications__WEBPACK_IMPORTED_MODULE_0__.fireNotification)(_plugins_Notifications__WEBPACK_IMPORTED_MODULE_0__.NotificationTypes.ADMIN_REGISTERED);
        router.push({
          name: "AdminDashboard"
        });
      });
